...
In [Part 1](/ai/dopamine-learning-algorithm), we covered how dopamine works—not as a pleasure signal, but as a temporal difference learning algorithm computing prediction errors in real time.

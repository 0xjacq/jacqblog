  ...
  return (
    <article className="group rounded-lg border border-border p-6 transition-colors hover:border-muted">
      <div className="flex flex-col gap-3">
        ...
        <p className="text-sm text-muted">{project.frontmatter.description}</p>
        ...
        {project.frontmatter.featured && (
          <span className="inline-flex w-fit items-center rounded-full bg-accent/10 px-2.5 py-0.5 text-xs text-accent">
            Featured
          </span>
        )}
      </div>
